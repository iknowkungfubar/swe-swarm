...
class CodeWriterAgent(BaseAgent):
    ...
    async def perform_task(self, task: dict[str, Any]) -> AgentResponse:
        ...
        if "add" in description.lower():
            ...
            # Generic implementation for any description
            code = self._generate_generic_function(description)
            test = self._generate_generic_test(description)
...
'''
    ...
    def _generate_generic_function(self, description: str) -> str:
        ...
        # Create a safe function name from description
        import re

        words = re.findall(r"\w+", description.lower())
        func_name = "_".join(words[:3]) if words else "generic_function"
...
def {func_name}():
    ...
    # In a real system, this would be generated by an LLM.
    return "Function implemented: {description}"
'''

    def _generate_generic_test(self, description: str) -> str:
        """Generate a generic test for the function."""
        import re
...
import pytest
from calculator import {func_name}

def test_{func_name}_returns_string():
    result = {func_name}()
